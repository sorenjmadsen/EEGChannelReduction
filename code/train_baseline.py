...
model_list= [
  ('ShallowConvNet', ShallowConvNet(input_channels=128, hidden_channels=60, linear_layer=4140), 0.00005),
  ('DeepConvNet',    DeepConvNet(input_channels=128, linear_layer=1800), 0.00001),
  ('EEGNet',         EEGNet(input_channels=128, linear_layer=1125), 0.00001),
  ('EEGInception',   EEGInception(input_channel=128), 0.000001)
]
